...
class Chat:
	def __init__(self):
		...
		self.realm = None
		target_realm_address = '127.0.0.1'
		target_realm_port = 8891
...
if __name__=="__main__":
	...
	#print j.send_message(tokenid,'lineker','messi','hello dari lineker')

	print(j.proses("sendgroup {} pemain_bola son, ker, kapan kita futsal bareng?" . format(tokenid)))
	print(j.proses("inbox {}" . format(tokenid)))

	print(j.proses("sendrealm {} {} henderson katanya mau futsal bareng, kapan?" . format(tokenid, j.realm._name)))
	print(j.proses("sendgrouprealm {} {} pemain_bola ayo tentuin hari kita futsal bareng" . format(tokenid, j.realm._name)))
